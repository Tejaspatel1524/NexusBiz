...
/**
 * AI Generate Ideas - Vercel Serverless Function
 * Uses Groq API for cloud AI inference
 */

const log = (msg: string) => console.log(`[GenerateIdeas] ${new Date().toISOString()}: ${msg}`);
